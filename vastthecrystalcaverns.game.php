 ...
 * -----
 * 
 * vastthecrystalcaverns.game.php
 *
...
class VastTheCrystalCaverns extends Table
{
    ...
    */
    ...
    /*
        ...
        (note: each method below must match an input method in vastthecrystalcaverns.action.php)
    */
